...
class BookingSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        model = Booking
        fields = [
            'id', 'booking_id', 'trek', 'trek_details',
            'full_name', 'email', 'phone', 'country_code',
            'whatsapp_number', 'country', 'number_of_people',
            'start_date', 'special_requests', 'price_per_person',
...
class BookingCreateSerializer(serializers.ModelSerializer):
    class Meta:
        model = Booking
        fields = [
            'trek', 'full_name', 'email', 'phone', 'country_code',
            'whatsapp_number', 'country', 'number_of_people',
            'start_date', 'special_requests',
        ]